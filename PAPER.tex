...
the amount of signal loss accompanying a weighting scheme used in OQE power spectrum estimation. In particular, we highlight major differences from the signal loss 
