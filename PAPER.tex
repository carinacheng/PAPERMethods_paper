...
The resulting limits for inverse covariance weighted PAPER-64 data (the same data used in Method \#1), using this second signal loss method, are shown in Figure \ref{fig:sigloss_compare} next to the limits from Method \#1. \dcj{Hopefully they are similar!} In the rest of this paper, we use Method \#1 \cc{why?}.

\begin{figure}[t]
\centering
\includegraphics[width=.4\textwidth]{plots/sigloss_method_comparison.png}
\caption{A comparison of Method \#1 
signal loss corrected power spectrum (black dots)
and Method \#2 uppers limits at 90\% confidence (red curve).
