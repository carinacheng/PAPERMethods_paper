...
\begin{figure*}
	\centering
	\includegraphics[height=0.3\textwidth]{paper_dipole.png}
	\includegraphics[height=0.3\textwidth]{antenna_layout.png}
...
\cc{TO DO: summarize redundant\&absolute calibration, fg-clean, LST-binning, FRF}

\section{Power Spectrum Analysis}
\label{sec:PS}

We use optimal quadratic estimators as explained by \cc{??} in order to form our final power spectrum quantities. For the reader's convenience, we summarize the method here, as well as highlight changes that we have made for our most recent analysis.

\cc{TO DO: summarize OQE formalism and bootstrapping}
\cc{Don't forget to explain new PS channels, like noise and eor, and how they're created}

\subsection{Signal Loss Formalism}
\label{sec:Sigloss}
