...
The author would like acknowledge the UC Berkeley Chancellor's Fellowship, National Science Foundation Graduate Research Fellowship (Division of Graduate Education award 1106400), and thank Eric Switzer for helpful discussions. PAPER and HERA are supported by grants from the National Science Foundation (awards 0804508, 1129258, 1125558, 1440343, and 1636646). ARP, JCP, DCJ, and JEA would also like to acknowledge NSF support (awards 1352519, 1302774, 1401708, and 1455151, respectively). We also graciously thank SKA-SA for site infrastructure and observing support.
\label{sec:Ack}
