...
\item The rate at which empirical eigenvectors converge to their true forms depends on sample variance in the empirical estimate and the steepness of the empirical eigenspectrum (Section \ref{sec:toymodel_frf}). In general, larger sample variances and flatter eigenspectra lead to more loss.
