...
\jp{This figure needs updating (as does this caption).  The text seems to have settled on $P_{\rm out}$ referring to $\widehat{\textbf{p}}_{r} - \widehat{\textbf{p}}_{x}$, whereas this signal loss methodology uses only $\widehat{\textbf{p}}_{r}$.  So the y-axis needs to change.}
}
\label{fig:Pr_vs_Pin}
\end{figure}  
