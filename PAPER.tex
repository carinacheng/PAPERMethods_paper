...
bootstrapping step along time entirely and now simply bootstrap over baselines. Power spectrum $2\sigma$ upper limits with this bootstrapping change for fringe-rate filtered noise are shown in Figure 
...
\begin{figure}
	...
	\caption{$2\sigma$ power spectrum upper limits for a noise simulation (computed via Equation \eqref{eq:noise} using PAPER-64 observing parameters) using two different bootstrapping 
