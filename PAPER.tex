...
a higher limit than \citetalias{ali_et_al2015} by a factor of $\sim7$ in mK (though we only use one baseline type in our analysis as opposed to three). 
...
$k=0.34$ $h$Mpc$^{-1}$, a higher limit than \citetalias{ali_et_al2015} by a factor of $\sim7$ in mK \cc{replace with kolopanis limit later}.}
	\label{fig:ps1_data}
\end{figure*}
...
\citetalias{ali_et_al2015} by a factor of $\sim7$ in mK \cc{replace with kolopanis limit later}. The reasons for a previously underestimated limit and 
