...
This is lower than the $T_{sys}$ of $500$\,K used in \citetalias{ali_et_al2015} because of several small mis-calculation errors that were 
...
\end{equation}
\noindent where, as with the \citetalias{ali_et_al2015} analysis, $N_{gps} = 5$. Each baseline group averages down linearly as the number of baselines 
