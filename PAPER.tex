...
estimate of signal loss (by a factor of $\sim$$10$), likely due to the use of the fringe-rate filter as a simulator. Whether the loss would be estimated at the same level if different $21$ cm simulations were used remains an open question.}
