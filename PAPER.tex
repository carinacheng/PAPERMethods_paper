...
two major changes in the way we estimate errors since A15, using the lessons we've learned about sampling with replacement 
...
group. In A15, baselines were chosen for groups randomly with replacement. In doing so, $\sim3$$-4$ baselines per group 
were repeated (Figure \ref{fig:toy_error2} shows the fraction of independent samples to be $\sim$$63\%$ for $10$ total 
